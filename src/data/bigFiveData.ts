...
export const BIG_FIVE_QUESTIONS: Question[] = [
  { id: 'O1', text: '面对一份从未尝试过的异国料理，我的第一反应是好奇而非警惕。', trait: 'O', reverse: false },
  { id: 'O2', text: '读完一本好书后，我常会花很长时间思考其中蕴含的深层含义。', trait: 'O', reverse: false },
  { id: 'O3', text: '在博物馆里，我常常因为一件作品驻足很久，沉浸在它传达的情感中。', trait: 'O', reverse: false },
  { id: 'O4', text: '当大多数人认同某个观点时，我反而会想去探究反面论据。', trait: 'O', reverse: false },
  { id: 'O5', text: '如果有机会去一个文化完全不同的地方生活三个月，我会毫不犹豫地接受。', trait: 'O', reverse: false },
  { id: 'O6', text: '我经常在脑海中构建虚构的场景和故事，并乐在其中。', trait: 'O', reverse: false },
  { id: 'O7', text: '当一种做事方法已经行之有效时，我觉得没有必要去寻找替代方案。', trait: 'O', reverse: true },
  { id: 'O8', text: '面对抽象的哲学讨论，我通常觉得离实际生活太远而提不起兴趣。', trait: 'O', reverse: true },
  { id: 'O9', text: '旅行时，我更倾向于重游熟悉的地方，而非探索完全陌生的目的地。', trait: 'O', reverse: true },
  { id: 'O10', text: '我很少被音乐、电影或艺术作品触动到落泪或起鸡皮疙瘩。', trait: 'O', reverse: true },
  { id: 'O11', text: '当有人提出一个颠覆常识的新理论时，我的第一反应是怀疑而非好奇。', trait: 'O', reverse: true },
  { id: 'O12', text: '在讨论中，我更享受那些没有标准答案的话题，而非有明确结论的议题。', trait: 'O', reverse: false },

  { id: 'C1', text: '即使没有人监督，我也能严格按照既定计划推进工作。', trait: 'C', reverse: false },
  { id: 'C2', text: '我的文件和物品都有固定的归放位置，很少需要翻找。', trait: 'C', reverse: false },
  { id: 'C3', text: '一旦对他人做出承诺，即使后来发现很麻烦，我也会坚持兑现。', trait: 'C', reverse: false },
  { id: 'C4', text: '在提交任何工作成果前，我都会反复检查细节，即使已经花了很多时间。', trait: 'C', reverse: false },
  { id: 'C5', text: '出发旅行前，我通常会提前列好详细的行李清单和行程安排。', trait: 'C', reverse: false },
  { id: 'C6', text: '当一个长期项目看不到即时回报时，我仍能保持稳定的投入节奏。', trait: 'C', reverse: false },
  { id: 'C7', text: '我经常在截止日期前才开始赶工，尽管之前有充足的时间。', trait: 'C', reverse: true },
  { id: 'C8', text: '打开我的衣柜或抽屉，你很难找到两件按类别整齐排列的物品。', trait: 'C', reverse: true },
  { id: 'C9', text: '我有时会为了眼前的轻松而推迟重要的任务，即使知道以后会更麻烦。', trait: 'C', reverse: true },
  { id: 'C10', text: '在需要长时间专注的任务中，我经常中途被其他事情吸引走。', trait: 'C', reverse: true },
  { id: 'C11', text: '我有不少开了头但始终没有完成的项目或计划。', trait: 'C', reverse: true },
  { id: 'C12', text: '做重要决定时，我会系统性地列出利弊，而不是凭直觉行事。', trait: 'C', reverse: false },

  { id: 'E1', text: '在持续社交三小时后，我通常感到精力充沛而非疲惫。', trait: 'E', reverse: false },
  { id: 'E2', text: '参加一个几乎不认识任何人的聚会，我会主动找人攀谈而非等待被搭话。', trait: 'E', reverse: false },
  { id: 'E3', text: '在团队讨论中，我通常是率先发言并引导话题方向的那个人。', trait: 'E', reverse: false },
  { id: 'E4', text: '当所有人的目光聚焦在我身上时，我感到兴奋而非不安。', trait: 'E', reverse: false },
  { id: 'E5', text: '周末如果没有社交活动，我会觉得少了点什么。', trait: 'E', reverse: false },
  { id: 'E6', text: '和陌生人聊天时，我很快就能找到共同话题并聊得热络。', trait: 'E', reverse: false },
  { id: 'E7', text: '经过一天与人频繁互动后，我最渴望的是一个人安静地待着。', trait: 'E', reverse: true },
  { id: 'E8', text: '在群体中，我更倾向于观察和倾听，而非主动表达自己的观点。', trait: 'E', reverse: true },
  { id: 'E9', text: '我经常选择用文字消息而非电话来沟通，因为说话更费精力。', trait: 'E', reverse: true },
  { id: 'E10', text: '如果可以自由选择，我更愿意独自完成一个项目而非与人合作。', trait: 'E', reverse: true },
  { id: 'E11', text: '被突然推到台前即兴发言时，我需要好一会儿才能组织好语言。', trait: 'E', reverse: true },
  { id: 'E12', text: '我喜欢在朋友圈或社交平台上分享自己的日常和想法。', trait: 'E', reverse: false },

  { id: 'A1', text: '即使曾被某人辜负，我仍倾向于给予第二次机会。', trait: 'A', reverse: false },
  { id: 'A2', text: '当朋友深夜来电倾诉烦恼时，我的第一反应是倾听而非建议。', trait: 'A', reverse: false },
  { id: 'A3', text: '在意见分歧时，我更愿意寻找折中方案，而非坚持己见。', trait: 'A', reverse: false },
  { id: 'A4', text: '看到陌生人在公共场合遇到困难，我会不假思索地上前帮忙。', trait: 'A', reverse: false },
  { id: 'A5', text: '即使对方的观点我不认同，我也能理解他们为何那样想。', trait: 'A', reverse: false },
  { id: 'A6', text: '在团队合作中，我更在意维持良好氛围，而非证明自己是对的。', trait: 'A', reverse: false },
  { id: 'A7', text: '当有人反复抱怨同一件事时，我很难保持耐心继续倾听。', trait: 'A', reverse: true },
  { id: 'A8', text: '我认为在谈判中适度夸大自己的立场是合理的策略。', trait: 'A', reverse: true },
  { id: 'A9', text: '如果同事犯了影响我的错误，我会直接指出而非委婉暗示。', trait: 'A', reverse: true },
  { id: 'A10', text: '我倾向于认为大多数人在背后都有自己的算盘。', trait: 'A', reverse: true },
  { id: 'A11', text: '面对别人的批评，我的第一反应是为自己辩护而非反思。', trait: 'A', reverse: true },
  { id: 'A12', text: '我很难对别人的请求说"不"，即使那会给自己带来不便。', trait: 'A', reverse: false },

  { id: 'N1', text: '在做出重要决定后，我经常反复质疑自己是否做了正确的选择。', trait: 'N', reverse: true },
  { id: 'N2', text: '别人一句无心的评价，可能会让我在意好几天。', trait: 'N', reverse: true },
  { id: 'N3', text: '在等待重要结果公布的那段时间，我几乎无法集中精力做其他事。', trait: 'N', reverse: true },
  { id: 'N4', text: '当事情没有按预期发展时，我很难迅速调整心态继续前进。', trait: 'N', reverse: true },
  { id: 'N5', text: '我有时会在深夜突然回想起白天的尴尬瞬间，并为此辗转难眠。', trait: 'N', reverse: true },
  { id: 'N6', text: '面对多个待办事项时，我常感到不知所措，不知从何开始。', trait: 'N', reverse: true },
  { id: 'N7', text: '在突发状况面前，我通常能很快冷静下来并找到应对方法。', trait: 'N', reverse: false },
  { id: 'N8', text: '即使经历了糟糕的一天，我也能在睡前把负面情绪放下。', trait: 'N', reverse: false },
  { id: 'N9', text: '面对他人的批评，我能比较客观地评估其合理性，而非被情绪裹挟。', trait: 'N', reverse: false },
  { id: 'N10', text: '在高压环境下，我反而比平时更加专注和高效。', trait: 'N', reverse: false },
  { id: 'N11', text: '当计划突然被打乱时，我很少感到沮丧，而是迅速想替代方案。', trait: 'N', reverse: false },
  { id: 'N12', text: '在社交场合中，我时常担心别人在评判我的一言一行。', trait: 'N', reverse: true }
];
