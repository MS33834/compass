...
export const STRESS_LEVELS = {
  low: {
    ...
    range: [0, 30],
    description:
      '你目前处于良好的压力管理状态，能够很好地应对生活中的各种挑战。保持现在的生活方式，继续关注自己的身心健康。',
    color: 'green',
    detailed: {
  ...
  medium: {
    ...
    range: [31, 60],
    description:
      '你正经历一定程度的压力，但还在可控范围内。适当调整生活节奏，采取一些压力管理措施会对你有帮助。',
    color: 'yellow',
    detailed: {
  ...
  high: {
    ...
    range: [61, 90],
    description:
      '你目前正经历较高的压力水平，这可能会影响你的身心健康。建议采取积极的应对措施，必要时寻求专业帮助。',
    color: 'orange',
    detailed: {
  ...
  extreme: {
    ...
    range: [91, 120],
    description:
      '你目前正经历严重的压力危机，这可能严重影响你的身心健康。请立即寻求专业帮助，不要独自面对。',
    color: 'red',
    detailed: {
...
export const HEALTHY_HABITS = {
  sleep: ['保持规律的睡眠时间', '创造良好的睡眠环境', '睡前1小时避免屏幕', '7-9小时睡眠时间'],
  nutrition: [
    '均衡饮食，减少咖啡因和糖',
    '多喝水，保持水分',
    '规律进食，不要跳餐',
  ...
  social: ['保持社交联系', '与支持你的人相处', '学会倾诉和倾听', '建立健康边界'],
};
