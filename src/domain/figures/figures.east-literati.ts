...
//   B 偏外：思辨 0.65-0.85 ── 荀子、屈原、柳宗元、王阳明、朱熹、谭嗣同（用王夫之代）
//   C 中段：0.40-0.60 ── 孔子、孟子、陶渊明、王维、韩愈、欧阳修
//   D 偏内：思辨 0.20-0.40 ── 司马迁、杜甫、白居易、苏轼、陆游、张岱
//   E 极端内：思辨 ≤ 0.20 ── 荀子（同 B）、曾国藩、李渔、袁枚、纳兰性德、李清照
...
export const FIGURES_EAST_LITERATI: readonly Figure[] = [
  ...
  },
  {
    ...
    era: '清',
    domain: 'east-literati',
    vector: [0.78, 0.7, 0.9, 0.95, 0.65, 0.45, 0.95, 0.8, 0.35, 0.7, 0.95, 0.55],
    signature: '我自横刀向天笑，去留肝胆两昆仑。',
    bio: '字复生，号壮飞，湖南浏阳人。少时师从欧阳中鹄，后入尊为「清末四大公子」之一。倡维新、办《时务报》、入戊戌。事败从容就义，年三十三。',
    portrait: 'portraits/east-literati/tansitong.svg',
    matchBlurb: '汝与 {{name}} 同，以身为炬，敢以颈血洗乾坤。',
    anecdotes: [
      { title: '望门投止', body: '流亡途中，乡人争匿之，曾有「望门投止思张俭」之句。' },
      { title: '狱中题壁', body: '临刑前狱中壁题「我自横刀向天笑」，气壮山河。' },
    ],
    echoes: ['el-wanganshi', 'el-lizhi', 'el-wangfuzhi'],
  },
