export default {
  ...
  results: {
    ...
    ssrsIntro:
      '《社会支持评定量表》(SSRS) 由中国心理学家肖水源 1986 年编制，是评估个体社会支持状况的本土化标准工具。它从客观支持、主观支持与支持利用度三个维度全面衡量你的人际资源。',
    mbiIntro:
      '《Maslach 职业倦怠量表 - 通用版》(MBI-GS) 是评估工作倦怠最权威的工具，Maslach & Jackson 1996 年版本,适用于所有职业。它从情感耗竭、犬儒主义与职业效能三个维度刻画你的工作状态。',
    swlsIntro:
      '《生活满意度量表》(SWLS) 由 Diener 等人 1985 年编制,是主观幸福感研究中的标准认知指标,只 5 道题,衡量你对生活质量的整体判断。',
    resilienceIntro:
      '《心理韧性量表》(CD-RISC-10) 由 Connor & Davidson 2003 年编制,是评估心理复原力的短版标准工具。它衡量你在面对压力、变化和逆境时的恢复与成长能力。',
    yourSSRS: '你的社会支持报告',
    yourMBI: '你的职业倦怠报告',
    yourSWLS: '你的生活满意度报告',
    yourResilience: '你的心理韧性报告',
