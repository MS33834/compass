  ...
  return (
    <div className="space-y-8">
      <div className="text-center py-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">{i18n.about.title}</h1>
        <p className="text-lg text-slate-600 max-w-2xl mx-auto">{i18n.about.subtitle}</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 shadow-lg border border-slate-200">
          ...
          <p className="text-slate-600 leading-relaxed">{i18n.about.mission.description}</p>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
              <h3 className="font-bold text-slate-800 mb-2">
                {i18n.about.features.scientific.title}
              </h3>
            ...
            <div className="p-4 bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl">
              <h3 className="font-bold text-slate-800 mb-2">
                {i18n.about.features.guidance.title}
              </h3>
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 shadow-lg border border-slate-200">
          ...
          <p className="text-slate-600">{i18n.about.contact.description}</p>
